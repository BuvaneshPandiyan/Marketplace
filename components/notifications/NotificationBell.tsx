            ...
            {notifications.map((n, i) => {
              ...
              return (
                <li key={n.id} style={{ borderBottom: "1px solid #f3f4f6" }}>
                  <Link href={href} style={{ display: "block", textDecoration: "none", color: "inherit", transition: "background 150ms ease" }}
    ...
    <>
      ...
      <div ref={containerRef} style={{ position: "relative" }}>
        ...
        <button type="button" onClick={handleOpen} aria-label="Open notifications"
          className="bell-btn"
          style={{ width: 44, height: 44, borderRadius: "50%", border: "none", background: "transparent", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", position: "relative", color: "#4b5563" }}>
