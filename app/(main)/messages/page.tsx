...
export default async function MessagesPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f4f2" }}>
      ...
      {/* ── CONVERSATION LIST ── */}
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "20px 12px 48px" }}>
        {/* Page heading */}
        <h1 style={{ fontSize: "clamp(18px,3vw,26px)", fontWeight: 900, color: "#111", letterSpacing: "-0.02em", margin: "0 4px 16px", display: "flex", alignItems: "center", gap: 8 }}>
          💬 Chats
          {totalUnread > 0 && (
            <span style={{ fontSize: 12, padding: "2px 10px", borderRadius: 100, background: "linear-gradient(135deg,#ea580c,#f97316)", color: "white", fontWeight: 700 }}>
              {totalUnread} new
            </span>
          )}
        </h1>
